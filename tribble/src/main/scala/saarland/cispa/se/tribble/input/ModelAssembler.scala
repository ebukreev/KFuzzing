...
class ModelAssembler(maxRepetitions: Int, automatonCache: AutomatonCache, damping: Double, similarity: Double, transformRegexes: Boolean = false, mergeLiterals: Boolean = false) {
